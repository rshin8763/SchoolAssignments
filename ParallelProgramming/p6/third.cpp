...
{
    for(int num_elements = 1024; num_elements <= 8*1024*1024; num_elements *= 4){
        for(int local_size = 1; local_size <= 1024; local_size *= 4){
            ...
            fprintf( stderr, "%8d\t%4d\t%10d\t%10.3lf GigaMultAddsPerSecond\n",
